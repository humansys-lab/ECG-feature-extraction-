...
from ..detection.qrs import _qrs_fiducial_from_local_waveform
...
from ..measurement.profiles.twelve_sl import twelve_sl_wave_measurements_from_signal
from ..measurement.u_wave import measure_u_wave
from ...refinement import RefinementConfig
from .refinement import sustained_qrs_offset
...
def delineate_beats(
    ...
    if out:
        ...
        if refinement is not None and (refinement.p_phasor_candidates or refinement.p_pathology_candidates):
            from .candidates import phasor_p_candidates
            from ..atrial.validation import p_waveform_evidence
