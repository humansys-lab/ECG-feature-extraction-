...
class PacingGroupingTests(unittest.TestCase):
    ...
    def test_extract_keeps_atrial_pacing_evidence_metadata_only(self) -> None:
        ...
        with patch("feature_extraction.ecgfeat.pipeline.stages.quality.compute_quality", return_value={}), \
             patch("feature_extraction.ecgfeat.pipeline.stages.quality.summarize_record_quality", return_value={}), \
             patch("feature_extraction.ecgfeat.pipeline.stages.quality.detect_limb_lead_reversal", return_value={}), \
             patch_calls("feature_extraction.ecgfeat.pipeline.stages.quality.detect_pacing_spikes", "feature_extraction.ecgfeat.pipeline.policies.pacing.detect_pacing_spikes", return_value={"spike_times": spike_times, "paced": True, "state": "on", "lead_vote_count": 5}), \
             patch_calls("feature_extraction.ecgfeat.pipeline.stages.ventricular.validate_pacing_spikes_against_qrs", "feature_extraction.ecgfeat.pipeline.policies.pacing.validate_pacing_spikes_against_qrs", return_value={
                 "spike_times": spike_times,
                 "paced": False,
                 "state": "unknown",
                 "lead_vote_count": 5,
    ...
    def test_extract_downgrades_metadata_only_pacing_to_unknown_measurement_state(self) -> None:
        ...
        with patch("feature_extraction.ecgfeat.pipeline.stages.quality.compute_quality", return_value={}), \
             patch("feature_extraction.ecgfeat.pipeline.stages.quality.summarize_record_quality", return_value={}), \
             patch("feature_extraction.ecgfeat.pipeline.stages.quality.detect_limb_lead_reversal", return_value={}), \
             patch_calls("feature_extraction.ecgfeat.pipeline.stages.quality.detect_pacing_spikes", "feature_extraction.ecgfeat.pipeline.policies.pacing.detect_pacing_spikes", return_value={
                 "spike_times": [120],
                 "paced": True,
                 "state": "on",
                 "lead_vote_count": 6,
